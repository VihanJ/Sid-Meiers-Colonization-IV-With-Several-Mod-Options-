...
public:
	...
	DllExport bool isWBAsianNative() const;
	DllExport void setWBAsianNative(bool bValue);
	DllExport bool isWBNAmericanNative() const;
	DllExport void setWBNAmericanNative(bool bValue);
	DllExport bool isWBSAmericanNative() const;
	DllExport void setWBSAmericanNative(bool bValue);
	DllExport bool isWBAfricanNative() const;
	DllExport void setWBAfricanNative(bool bValue);
	DllExport bool isWBPacificNative() const;
	DllExport void setWBPacificNative(bool bValue);
protected:
	bool m_bWBAsianNative;
	bool m_bWBNAmericanNative;
	bool m_bWBSAmericanNative;
	bool m_bWBAfricanNative;
	bool m_bWBPacificNative;
public:
	// Dale - AoD: Natives END

	// PatchMod: Cutscene START
	DllExport void doCutscene();
	// PatchMod: Cutscene END
	// PatchMod: FoY START
	DllExport void doFoY();
protected:
	bool bFoY;
public:
	// PatchMod: FoY END
