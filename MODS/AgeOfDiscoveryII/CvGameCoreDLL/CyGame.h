...
public:
	...
	bool isWBAsianNative();
	void setWBAsianNative(bool bValue);
	bool isWBNAmericanNative();
	void setWBNAmericanNative(bool bValue);
	bool isWBSAmericanNative();
	void setWBSAmericanNative(bool bValue);
	bool isWBAfricanNative();
	void setWBAfricanNative(bool bValue);
	bool isWBPacificNative();
	void setWBPacificNative(bool bValue);
