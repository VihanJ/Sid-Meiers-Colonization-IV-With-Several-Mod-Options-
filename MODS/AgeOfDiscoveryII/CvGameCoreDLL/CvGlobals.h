...
public:
	...
	// PatchMod: Cutscene START
protected:
	std::vector<CvCutsceneInfo*> m_paCutsceneInfo;
public:
	DllExport int getNumCutsceneInfos();
	DllExport std::vector<CvCutsceneInfo*>& getCutsceneInfo();
	DllExport CvCutsceneInfo& getCutsceneInfo(CutsceneTypes eCutscene);
	// PatchMod: Cutscene END
