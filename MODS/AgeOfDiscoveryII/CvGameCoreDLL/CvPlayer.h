...
protected:
	int m_iYieldNeededPrice;
	int m_iBuildItemNumber;
public:
	void setYieldNeededPrice(int iValue);
	int getYieldNeededPrice();
	void setBuildItemNumber(int iValue);
	int getBuildItemNumber();
	// PatchMod: Allow yield shortage purchase on build END

	// PatchMod: Victorys START
protected:
	int m_iTotalGoodsTradedVictory;
	int m_iTotalPiratePlunder;
public:
	void setTotalGoodsTradedVictory(int iValue);
	int getTotalGoodsTradedVictory();
	void setTotalPiratePlunder(int iValue);
	int getTotalPiratePlunder();
	// PatchMod: Victorys END

	// PatchMod: AI immigration boost START
	void doAIImmigrant(int iIndex);
	void doFoYImmigrant(int iIndex);
...
public:
	...
	int getYieldStoredHistory(int iTurn, YieldTypes eYield) const;
	void updateYieldStoredHistory(int iTurn, YieldTypes eYield, int iYieldStored);
	int getYieldRateHistory(int iTurn, YieldTypes eYield) const;
	void updateYieldRateHistory(int iTurn, YieldTypes eYield, int iYieldStored);
...
protected:
	...
	// < JTradeRoutes Mod Start >
	//CvTurnScoreMap
	int** m_aaiYieldStoredHistory;
	int** m_aaiYieldRateHistory;
	// < JTradeRoutes Mod End >
