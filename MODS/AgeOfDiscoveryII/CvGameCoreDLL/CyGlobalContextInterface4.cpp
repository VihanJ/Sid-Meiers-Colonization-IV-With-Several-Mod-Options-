...
void CyGlobalContextPythonInterface4(python::class_<CyGlobalContext>& x)
{
	...
	x
		...
		.def("getNumCutsceneInfos", &CyGlobalContext::getNumCutsceneInfos)
		.def("getCutsceneInfo", &CyGlobalContext::getCutsceneInfo, python::return_value_policy<python::reference_existing_object>(), "Returns info object")
