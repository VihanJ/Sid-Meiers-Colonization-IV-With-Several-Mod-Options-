...
void CyInfoPythonInterface3()
{
	...
	python::class_<CvEuropeInfo, python::bases<CvInfoBase> >("CvEuropeInfo")
		...
		.def("getWestTripLength", &CvEuropeInfo::getWestTripLength, "int ()")
	...
	python::class_<CvCutsceneInfo, python::bases<CvInfoBase> >("CvCutsceneInfo")
		.def("getPictureFileName", &CvCutsceneInfo::getPictureFileName, "string ()")
		.def("getPictureX", &CvCutsceneInfo::getPictureX, "int ()")
		.def("getPictureY", &CvCutsceneInfo::getPictureY, "int ()")
		;
