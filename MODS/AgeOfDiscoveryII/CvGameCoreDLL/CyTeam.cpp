...
int CyTeam::getTotalGoodsTraded()
{
	return m_pTeam ? m_pTeam->getTotalGoodsTraded() : 0;
}
...
int CyTeam::getTotalPiratePlunder()
{
	return m_pTeam ? m_pTeam->getTotalPiratePlunder() : 0;
}
