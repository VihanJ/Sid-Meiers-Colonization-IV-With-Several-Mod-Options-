...
public:
	...
	int getTurnsInJob();
	void setTurnsInJob(int iValue);
	bool processProfessionUpgrade();
protected:
	int m_iTurnsInJob;
public:
...
public:
	...
	bool processUnitFreedom();
	// PatchMod: Unit freedom END

	// PatchMod: Education revamp START
protected:
	int m_iLearningProfession;
public:
	int getLearningProfession() const;
	void setLearningProfession(int iValue);
	bool processSchoolTest();
...
protected:
	int m_iToryValue;
public:
	int getToryValue() const;
	void setToryValue(int iValue);
	void changeToryValue(int iValue);
	bool processToryChange(int iValue, bool bApply = true);
	// PatchMod: Tories END
