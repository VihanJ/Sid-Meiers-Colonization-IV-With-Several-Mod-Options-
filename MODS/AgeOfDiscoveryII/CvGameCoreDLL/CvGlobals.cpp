...
int CvGlobals::getNumCutsceneInfos()
{
	return (int)m_paCutsceneInfo.size();
}

std::vector<CvCutsceneInfo*>& CvGlobals::getCutsceneInfo()
{
	return m_paCutsceneInfo;
}

CvCutsceneInfo& CvGlobals::getCutsceneInfo(CutsceneTypes eCutscene)
{
	FAssert(eCutscene > -1);
	FAssert(eCutscene < GC.getNumCutsceneInfos());
	return *(m_paCutsceneInfo[eCutscene]);
}
