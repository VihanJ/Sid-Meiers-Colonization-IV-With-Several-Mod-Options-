...
void CyEnumsPythonInterface()
{
	...
	python::enum_<ButtonPopupTypes>("ButtonPopupTypes")
		...
		.value("BUTTONPOPUP_CUTSCENE", BUTTONPOPUP_CUTSCENE)
		// PatchMod: Cutscene END
		// PatchMod: FoY START
		.value("BUTTONPOPUP_FOY", BUTTONPOPUP_FOY)
		// PatchMod: FoY END
	...
	python::enum_<TaskTypes>("TaskTypes")
		...
		.value("TASK_EDUCATESTART", TASK_EDUCATESTART)
		// PatchMod: Education revamp END
		// PatchMod: Shortfall START
		.value("TASK_BUYBUILDSHORTFALL", TASK_BUYBUILDSHORTFALL)
		.value("TASK_BUYUNITSHORTFALL", TASK_BUYUNITSHORTFALL)
	...
	python::enum_<ControlTypes>("ControlTypes")
		...
		.value("CONTROL_PIRATE_SCREEN", CONTROL_PIRATE_SCREEN)
