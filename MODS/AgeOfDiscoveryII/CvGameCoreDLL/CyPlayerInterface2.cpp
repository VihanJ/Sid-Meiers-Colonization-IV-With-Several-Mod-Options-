...
void CyPlayerPythonInterface2(python::class_<CyPlayer>& x)
{
	...
	x
		...
		.def("getYieldStoredHistory", &CyPlayer::getYieldStoredHistory, "int (int iTurn, int /*YieldTypes*/ eYield)")
		.def("getYieldRateHistory", &CyPlayer::getYieldRateHistory, "int (int iTurn, int /*YieldTypes*/ eYield)")
