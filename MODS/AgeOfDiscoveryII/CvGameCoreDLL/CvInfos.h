...
public:
	...
	// PatchMod: Profession cargo change START
	DllExport int getProfCargoChange() const;
protected:
	int m_iProfCargoChange;
public:
	// PatchMod: Profession cargo change END

	// PatchMod: Profession upgrade unit START
	DllExport int getUpgradeUnit() const;
protected:
	int m_iUpgradeUnit;
public:
...
protected:
	bool m_bImpactEuropePrice;
public:
	DllExport bool isImpactEuropePrice() const;
	// PatchMod: Impact Europe price END

	// PatchMod: Zuuls tags START
protected:
	bool* m_abObsoleteBuildingClass;
	bool m_bSingleInstance;
public:
	DllExport bool getObsoleteBuildingClass(int i) const;
	DllExport bool isSingleInstance() const;
	// PatchMod: Zuuls tags END

	// PatchMod: Education revamp START
protected:
	int m_iEducationLevel;
public:
	DllExport int getEducationLevel() const;
...
public:
	...
	DllExport bool isPirates() const;
protected:
	bool m_bPirates;
public:
	...
	DllExport bool isAsianNative() const;
	DllExport bool isNAmericanNative() const;
	DllExport bool isSAmericanNative() const;
	DllExport bool isAfricanNative() const;
	DllExport bool isPacificNative() const;
protected:
	bool m_bAsianNative;
	bool m_bNAmericanNative;
	bool m_bSAmericanNative;
	bool m_bAfricanNative;
	bool m_bPacificNative;
public:
	// Dale - AoD: Natives END

	// Dale - AoD: Rev Flags START
	DllExport const char* getRevArtDefineTag() const;
	DllExport void setRevArtDefineTag(const char* szVal);
protected:
	CvString m_szRevArtDefineTag;
public:
	// Dale - AoD: Rev Flags END

	// PatchMod: Is from west START
	DllExport bool isFromWest() const;
protected:
	bool m_bFromWest;
public:
...
protected:
	int m_iTotalGoodsTraded;
	int m_iTotalProductionRate;
	int m_iTotalPiratePlunder;
public:
	DllExport int getTotalGoodsTraded() const;
	DllExport int getTotalProductionRate() const;
	DllExport int getTotalPiratePlunder() const;
	DllExport void setTotalGoodsTraded(int iValue);
	DllExport void setTotalProductionRate(int iValue);
	DllExport void setTotalPiratePlunder(int iValue);
...
protected:
	int m_iKingUnitIncreaseCap;
public:
	DllExport int getKingUnitIncreaseCap() const;
...
public:
	...
	// PatchMod: START
protected:
	bool m_bAlwaysApplyYieldIncreases;
public:
	bool getAlwaysApplyYieldIncreases() const;
	// PatchMod: END
...
protected:
	int m_iWestTripLength;
public:
	DllExport int getWestTripLength() const;
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//
//  class : CvCutsceneInfo
//
//  DESC:
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvCutsceneInfo : public CvInfoBase
{
public:
	DllExport CvCutsceneInfo();
	DllExport virtual ~CvCutsceneInfo();
	DllExport bool read(CvXMLLoadUtility* pXML);
	DllExport int getPictureX();
	DllExport int getPictureY();
	DllExport const wchar* getDescription() const;
