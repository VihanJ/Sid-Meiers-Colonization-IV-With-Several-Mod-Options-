...
void CyInfoPythonInterface2()
{
	...
	python::class_<CvCivilizationInfo, python::bases<CvInfoBase> >("CvCivilizationInfo")
		...
		.def("isPirates", &CvCivilizationInfo::isPirates, "bool ()")
		// Dale - AoD: Pirate Civ END
		// PatchMod: Western nations START
		.def("isFromWest", &CvCivilizationInfo::isFromWest, "bool ()")
	...
	python::class_<CvVictoryInfo, python::bases<CvInfoBase> >("CvVictoryInfo")
		...
		.def("getTotalGoodsTraded", &CvVictoryInfo::getTotalGoodsTraded, "int ()")
		.def("getTotalProductionRate", &CvVictoryInfo::getTotalProductionRate, "int ()")
		.def("getTotalPiratePlunder", &CvVictoryInfo::getTotalPiratePlunder, "int ()")
