...
int CyPlayer::getYieldStoredHistory(int iTurn, int /*YieldTypes*/ eYield) const
{
	return (NULL != m_pPlayer ? m_pPlayer->getYieldStoredHistory(iTurn, (YieldTypes) eYield) : 0);
}
int CyPlayer::getYieldRateHistory(int iTurn, int /*YieldTypes*/ eYield) const
{
	return (NULL != m_pPlayer ? m_pPlayer->getYieldRateHistory(iTurn, (YieldTypes) eYield) : 0);
}
...
bool CyPlayer::isPirates()
{
	return m_pPlayer ? m_pPlayer->isPirates() : false;
}
