...
void CyGamePythonInterface()
{
	...
	python::class_<CyGame>("CyGame")
		...
		.def("isWBAsianNative", &CyGame::isWBAsianNative)
		.def("setWBAsianNative", &CyGame::setWBAsianNative)
		.def("isWBNAmericanNative", &CyGame::isWBNAmericanNative)
		.def("setWBNAmericanNative", &CyGame::setWBNAmericanNative)
		.def("isWBSAmericanNative", &CyGame::isWBSAmericanNative)
		.def("setWBSAmericanNative", &CyGame::setWBSAmericanNative)
		.def("isWBAfricanNative", &CyGame::isWBAfricanNative)
		.def("setWBAfricanNative", &CyGame::setWBAfricanNative)
		.def("isWBPacificNative", &CyGame::isWBPacificNative)
		.def("setWBPacificNative", &CyGame::setWBPacificNative)
