...
class CvMilitaryAdvisor:
	...
	def interfaceScreen(self):
		...
		screen.addStackedBarGFC(szWidget, self.W_SCREEN / 4, self.Y_EXIT + 5, self.W_SCREEN / 4, 30, InfoBarTypes.NUM_INFOBAR_TYPES, WidgetTypes.WIDGET_GENERAL, -1, -1)
		...
		screen.setBarPercentage(szWidget, InfoBarTypes.INFOBAR_STORED, float(self.pActivePlayer.getCombatLandExperience()) / float(self.pActivePlayer.greatGeneralThreshold()))
		screen.setLabel(self.getNextWidgetName(), "", u"<font=3>" + localText.getText("TXT_KEY_MISC_GREAT_GENERAL", (self.pActivePlayer.getCombatLandExperience(), self.pActivePlayer.greatGeneralThreshold())) + u"</font>", CvUtil.FONT_CENTER_JUSTIFY, self.W_SCREEN * 3 / 8, self.Y_EXIT + 8, 0, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)

		# GREAT ADMIRAL
		szWidget = "GreaAdmiralBar"
		screen.addStackedBarGFC(szWidget, self.W_SCREEN / 2, self.Y_EXIT + 5, self.W_SCREEN / 4, 30, InfoBarTypes.NUM_INFOBAR_TYPES, WidgetTypes.WIDGET_GENERAL, -1, -1)
		screen.setStackedBarColors(szWidget, InfoBarTypes.INFOBAR_STORED, gc.getInfoTypeForString("COLOR_GREAT_PEOPLE_STORED"))
		screen.setStackedBarColors(szWidget, InfoBarTypes.INFOBAR_RATE, gc.getInfoTypeForString("COLOR_GREAT_PEOPLE_RATE"))
		screen.setStackedBarColors(szWidget, InfoBarTypes.INFOBAR_RATE_EXTRA, gc.getInfoTypeForString("COLOR_EMPTY"))
		screen.setStackedBarColors(szWidget, InfoBarTypes.INFOBAR_EMPTY, gc.getInfoTypeForString("COLOR_EMPTY"))
		screen.setBarPercentage(szWidget, InfoBarTypes.INFOBAR_STORED, float(self.pActivePlayer.getCombatSeaExperience()) / float(self.pActivePlayer.greatAdmiralThreshold()))
		screen.setLabel(self.getNextWidgetName(), "", u"<font=3>" + localText.getText("TXT_KEY_MISC_GREAT_ADMIRAL", (self.pActivePlayer.getCombatSeaExperience(), self.pActivePlayer.greatAdmiralThreshold())) + u"</font>", CvUtil.FONT_CENTER_JUSTIFY, self.W_SCREEN * 5 / 8, self.Y_EXIT + 8, 0, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
