...
class CvHallOfFameScreen:
	...
	def drawContents(self):
		...
		screen.setTableColumnHeader(self.TABLE_ID, 5, localText.getText("TXT_KEY_VICTORY", ()), 120)
		...
		screen.setTableColumnHeader(self.TABLE_ID, 9, localText.getText("TXT_KEY_HOF_SCREEN_GAME_SPEED", ()), 85)
