...
class CvGameUtils:
	...
	def createSeaway(self,argsList):
		px = argsList[0]
		py = argsList[1]
		CyMessageControl().sendModNetMessage(self.CREATE_SEAWAY, gc.getGame().getActivePlayer(), px, py, -1)
		return True
	...
	def getExperienceNeeded(self, argsList):
		...
		iExperienceNeeded = 2*iLevel * iLevel + 1
