...
class CvDiplomacy:
	...
	def determineResponses (self, eComment):
		...
		elif (self.isComment(eComment, "AI_DIPLOCOMMENT_STAT_LOAN")):
		
			if (not gc.getPlayer(gc.getGame().getActivePlayer()).getEuropeLoan() == 0):
				self.addUserComment("USER_DIPLOCOMMENT_INFO_LOAN", -1, -1)
				self.addUserComment("USER_DIPLOCOMMENT_REPAY_LOAN", -1, -1)
				
			self.addUserComment("USER_DIPLOCOMMENT_EXIT2", -1, -1)
			
		elif (self.isComment(eComment, "AI_DIPLOCOMMENT_STAT_LOAN_REPAY")):
		...
		elif (self.isComment(eComment, "AI_DIPLOCOMMENT_STAT_LOAN_INFO")):
		...
		elif (self.isComment(eComment, "AI_DIPLOCOMMENT_NO_LOAN_INFO")):
			self.addUserComment("USER_DIPLOCOMMENT_EXIT2", -1, -1)
		...
		#If AI Give Ships
		elif (self.isComment(eComment, "AI_DIPLO_ASK_LOAN_WAR_SHIP(S)")):
			
			# We can accept their demands
			self.addUserComment("USER1_DIPLO_ACCEPT_LOAN_WAR_SHIP(S)", -1, -1)

			# Or reject them...
			self.addUserComment("USER1_DIPLO_REFUSE_LOAN_WAR_SHIP(S)", -1, -1)

		# accept pinky ring
		elif (self.isComment(eComment, "AI_DIPLO_ACCEPT_LOAN_WAR_SHIP(S)")):

			self.addUserComment("USER2_DIPLO_ACCEPT_LOAN_WAR_SHIP(S)", -1, -1)

		elif (self.isComment(eComment, "AI_DIPLO_REFUSE_LOAN_WAR_SHIP(S)")):

			self.addUserComment("USER2_DIPLO_REFUSE_LOAN_WAR_SHIP(S)", -1, -1)
		...
		elif (self.isComment(eComment, "AI_DIPLO_KING_LOAN_MERCHANT_SHIP")):

			self.addUserComment("USER_DIPLO_KING_LOAN_MERCHANT_SHIP", -1, -1)
			
		elif (self.isComment(eComment, "AI_DIPLO_KING_GIVE_SCOUT")):

			self.addUserComment("USER_DIPLO_KING_BASIC_ANSWER", -1, -1)
			
		elif (self.isComment(eComment, "AI_DIPLO_KING_GIVE_MILITARY_SHIPS")):

			self.addUserComment("USER_DIPLO_KING_BASIC_ANSWER", -1, -1)
			
		elif (self.isComment(eComment, "AI_DIPLO_KING_GIVE_AGRONOMIST")):

			self.addUserComment("USER_DIPLO_KING_GIVE_AGRONOMIST", -1, -1)
			
		elif (self.isComment(eComment, "AI_DIPLO_KING_GIVE_AGRONOMIST_THANKS_TO_TEAMMATE")):

			self.addUserComment("USER_DIPLO_KING_GIVE_AGRONOMIST", -1, -1)
			
		elif (self.isComment(eComment, "AI_DIPLO_KING_SEND_AGRONOMISTS_IF_SOME_WERE_KILLED")):

			self.addUserComment("USER_DIPLO_KING_BASIC_ANSWER", -1, -1)
			
		elif (self.isComment(eComment, "AI_DIPLO_KING_ADVICE_FOR_AGRONOMISTS")):

			self.addUserComment("USER_DIPLO_KING_ADVICE_FOR_AGRONOMISTS", -1, -1)
			
		elif (self.isComment(eComment, "AI_DIPLO_KING_GIVE_AGRONOMIST_WITH_SEEDLING")):

			self.addUserComment("USER_DIPLO_KING_GIVE_AGRONOMIST_WITH_SEEDLING", -1, -1)
			
		elif (self.isComment(eComment, "AI_DIPLO_KING_LOAN_WAR_SHIP(S)+MERCHANT_SHIP")):

			self.addUserComment("USER_DIPLO_KING_LOAN_WAR_SHIP(S)+MERCHANT_SHIP", -1, -1)
			
		elif (self.isComment(eComment, "AI_DIPLO_KING_GIFT_FIRST_MERCHANT_SHIP")):

			self.addUserComment("USER_DIPLO_KING_GIFT_MERCHANT_SHIP", -1, -1)
		
		elif (self.isComment(eComment, "AI_DIPLO_KING_GIFT_FIRST_BUILDER_WAGON")):

			self.addUserComment("USER_DIPLO_KING_GIFT_MERCHANT_SHIP", -1, -1)
		
		elif (self.isComment(eComment, "AI_DIPLO_KING_GIFT_SECOND_MERCHANT_SHIP")):

			self.addUserComment("USER_DIPLO_KING_GIFT_MERCHANT_SHIP", -1, -1)
		
		elif (self.isComment(eComment, "AI_DIPLO_KING_GIFT_SECOND_BUILDER_WAGON")):

			self.addUserComment("USER_DIPLO_KING_GIFT_MERCHANT_SHIP", -1, -1)
		
		elif (self.isComment(eComment, "AI_DIPLO_KING_GIFT_GALEON_SHIP")):

			self.addUserComment("USER_DIPLO_ACCEPT_KING_GIFT_GALEON_SHIP", -1, -1)
			
			self.addUserComment("USER_DIPLO_REFUSE_KING_GIFT_GALEON_SHIP", -1, -1)
		
		elif (self.isComment(eComment, "AI_DIPLO_KING_GIFT_AND_LOAN_WAR_SHIPS")):

			self.addUserComment("USER_DIPLO_ACCEPT_GIFT_AND_LOAN_WAR_SHIPS", -1, -1)
			
			self.addUserComment("USER_DIPLO_REFUSE_GIFT_AND_LOAN_WAR_SHIPS", -1, -1)
		
		elif (self.isComment(eComment, "AI_DIPLO_KING_LOAN_TIME_RAPPEL")):

			self.addUserComment("USER_DIPLO_KING_LOAN_TIME_RAPPEL", -1, -1)
		
		elif (self.isComment(eComment, "AI_DIPLO_KING_LOAN_PUNISHMENT")):

			self.addUserComment("USER_DIPLO_KING_LOAN_PUNISHMENT", -1, -1)
		
		elif (self.isComment(eComment, "AI_DIPLO_KING_LOAN_STOP_PUNISHMENT")):

			self.addUserComment("USER_DIPLO_KING_LOAN_STOP_PUNISHMENT", -1, -1)
		
		elif (self.isComment(eComment, "AI_DIPLO_KING_LOAN_END_OF_PUNISHMENT")):

			self.addUserComment("USER_DIPLO_KING_LOAN_END_OF_PUNISHMENT", -1, -1)
		
		elif (self.isComment(eComment, "AI_DIPLO_KING_GIFT_WAR_SHIP")):
			
			self.addUserComment("USER_DIPLO_KING_GIFT_WAR_SHIP", -1, -1)
			
		elif (self.isComment(eComment, "AI_DIPLO_KING_GIFT_WAR_SHIP2")):
			
			self.addUserComment("USER_DIPLO_KING_GIFT_WAR_SHIP2", -1, -1)
			
		elif (self.isComment(eComment, "AI_DIPLO_ASK_LOAN_WAR_SHIP_NO_ATTACK")):
		
			self.addUserComment("USER1_DIPLO_ACCEPT_LOAN_WAR_SHIP_NO_ATTACK", -1, -1)
			
			self.addUserComment("USER1_DIPLO_REFUSE_LOAN_WAR_SHIP_NO_ATTACK", -1, -1)
		
		elif (self.isComment(eComment, "AI_DIPLO_ACCEPT_LOAN_WAR_SHIP_NO_ATTACK")):
		
			self.addUserComment("USER2_DIPLO_ACCEPT_LOAN_WAR_SHIP_NO_ATTACK", -1, -1)
		
		elif (self.isComment(eComment, "AI_DIPLO_REFUSE_LOAN_WAR_SHIP_NO_ATTACK")):
		
			self.addUserComment("USER2_DIPLO_REFUSE_LOAN_WAR_SHIP_NO_ATTACK", -1, -1)
			
		# If the AI is giving goodies to our scout
		elif (self.isComment(eComment, "AI_DIPLOCOMMENT_CHIEF_GOODY")):

			# accept
			self.addUserComment("USER1_DIPLOCOMMENT_CHIEF_GOODY", -1, -1)
		...
		elif (self.isComment(eComment, "AI_DIPLOCOMMENT_LIVE_AMONG_NATIVES_REFUSED")):

			# accept
			self.addUserComment("USER_DIPLOCOMMENT_LIVE_AMONG_NATIVES_REFUSED", -1, -1)
		...
		elif (self.isComment(eComment, "AI_DIPLOCOMMENT_FOUND_CITY_FREE")):

			self.addUserComment("USER_DIPLOCOMMENT_FOUND_CITY_BUY_FREE", -1, -1)
			self.addUserComment("USER_DIPLOCOMMENT_FOUND_CITY_CANCEL", -1, -1)
		...
		# We want make war to an other king
		elif (self.isComment(eComment, "AI_DIPLOCOMMENT_HELP_EUROPEAN_FRIEND")):

			# We can accept their demands
			self.addUserComment("USER_DIPLOCOMMENT_HELP_EUROPEAN_FRIEND", -1, -1)
			# Or reject them...
			self.addUserComment("USER_DIPLOCOMMENT_EXIT2", -1, -1)
		...
		# The default...
			...
			if (gc.getTeam(gc.getPlayer(self.diploScreen.getWhoTradingWith()).getTeam())).isParentOf(gc.getGame().getActiveTeam()):
				...
				if (not gc.getPlayer(gc.getGame().getActivePlayer()).getEuropeLoan() == 0):
					self.addUserComment("USER_DIPLOCOMMENT_LOAN_STAT", -1, -1)					
			else:
				self.addUserComment("USER_DIPLOCOMMENT_SOMETHING_ELSE", -1, -1)
	...
	def performHeadAction( self, eComment ):
		...
		if ( eComment == self.getCommentID("AI_DIPLOCOMMENT_NO_PEACE") or
		...
		elif ( eComment == self.getCommentID("AI_DIPLOCOMMENT_ATTITUDE_PLAYER_ANNOYED") or
				eComment == self.getCommentID("AI_DIPLO_ASK_LOAN_WAR_SHIP(S)")):
			self.diploScreen.performHeadAction( LeaderheadAction.LEADERANIM_ANNOYED )
		elif ( eComment == self.getCommentID("AI_DIPLOCOMMENT_ATTITUDE_PLAYER_CAUTIOUS") or
				eComment == self.getCommentID("AI_DIPLO_ASK_LOAN_WAR_SHIP_NO_ATTACK") or
				eComment == self.getCommentID("AI_DIPLOCOMMENT_HELP_EUROPEAN_FRIEND") or
				eComment == self.getCommentID("AI_DIPLO_ACCEPT_LOAN_WAR_SHIP_NO_ATTACK")):
			...
			self.diploScreen.performHeadAction( LeaderheadAction.LEADERANIM_PLEASED )
			   ...
			   eComment == self.getCommentID("AI_DIPLO_KING_LOAN_MERCHANT_SHIP") or
		       eComment == self.getCommentID("AI_DIPLO_KING_GIVE_SCOUT") or
		       eComment == self.getCommentID("AI_DIPLOCOMMENT_STAT_LOAN") or
			   eComment == self.getCommentID("AI_DIPLOCOMMENT_STAT_LOAN_INFO") or
			   eComment == self.getCommentID("AI_DIPLOCOMMENT_NO_LOAN_INFO") or
			...
			self.diploScreen.performHeadAction( LeaderheadAction.LEADERANIM_FRIENDLY )
		       ...
		       eComment == self.getCommentID("AI_DIPLOCOMMENT_KING_REVIVE") or
		       eComment == self.getCommentID("AI_DIPLO_KING_GIFT_WAR_SHIP") or
		       eComment == self.getCommentID("AI_DIPLO_KING_GIFT_WAR_SHIP2") or
			   eComment == self.getCommentID("AI_DIPLOCOMMENT_STAT_LOAN_REPAY")):
		...
		elif ( eComment == self.getCommentID("AI_DIPLOCOMMENT_REJECT_PINKY")):
	...
	def handleUserResponse(self, eComment, iData1, iData2):
		...
		elif (self.isComment(eComment, "USER_DIPLOCOMMENT_LOAN_STAT")):
			self.setAIComment(self.getCommentID("AI_DIPLOCOMMENT_STAT_LOAN"))
		...
		elif (self.isComment(eComment, "USER_DIPLOCOMMENT_INFO_LOAN")):
			iLoan = gc.getPlayer(gc.getGame().getActivePlayer()).getEuropeLoan()
			iLoanPercent = gc.getPlayer(gc.getGame().getActivePlayer()).getEuropeLoanPercent()
			if (not gc.getPlayer(gc.getGame().getActivePlayer()).getEuropeLoan() == 0):
				self.setAIComment(self.getCommentID("AI_DIPLOCOMMENT_STAT_LOAN_INFO"), iLoan, iLoanPercent)
			
			else:
				self.setAIComment(self.getCommentID("AI_DIPLOCOMMENT_NO_LOAN_INFO"))
				
			
		elif (self.isComment(eComment, "USER_DIPLOCOMMENT_REPAY_LOAN")):
			if (not gc.getPlayer(gc.getGame().getActivePlayer()).getEuropeLoan() == 0):
				diploScreen.diploEvent(DiploEventTypes.DIPLOEVENT_REPAY_LOAN, -1, -1);
				self.setAIComment(self.getCommentID("AI_DIPLOCOMMENT_STAT_LOAN_REPAY"))
			else:
				self.setAIComment(self.getCommentID("AI_DIPLOCOMMENT_NO_LOAN_INFO"))

		elif (self.isComment(eComment, "USER_DIPLOCOMMENT_EXIT2")):
			diploScreen.closeScreen()
			
		elif (self.isComment(eComment, "USER_DIPLO_KING_LOAN_MERCHANT_SHIP")):
			CyInterface().playGeneralSound("AS2D_KISS_MY_RING")
			diploScreen.closeScreen()
		
		elif (self.isComment(eComment, "USER_DIPLO_KING_GIVE_SCOUT")):
			CyInterface().playGeneralSound("AS2D_KISS_MY_RING")
			diploScreen.closeScreen()
		
		elif (self.isComment(eComment, "USER_DIPLO_KING_LOAN_WAR_SHIP(S)+MERCHANT_SHIP")):
			CyInterface().playGeneralSound("AS2D_KISS_MY_RING")
			diploScreen.closeScreen()
			
		elif (self.isComment(eComment, "USER_DIPLOCOMMENT_KING_GIFT_SHIP_DEFENDER_ONLY")):
			CyInterface().playGeneralSound("AS2D_KISS_MY_RING")
			diploScreen.closeScreen()
		...
		elif (self.isComment(eComment, "USER_DIPLO_ACCEPT_GIFT_AND_LOAN_WAR_SHIPS")):
			diploScreen.diploEvent(DiploEventTypes.DIPLOEVENT_KING_GIFT_SHIPS_DEFENDER, -1, -1);
			diploScreen.closeScreen()
		
		elif (self.isComment(eComment, "USER_DIPLO_ACCEPT_KING_GIFT_GALEON_SHIP")):
			diploScreen.diploEvent(DiploEventTypes.DIPLOEVENT_KING_GIFT_GALEON_SHIP, -1, -1);
			diploScreen.closeScreen()
		
		elif (self.isComment(eComment, "USER_DIPLO_REFUSE_KING_GIFT_GALEON_SHIP")):
			diploScreen.closeScreen()
		
		elif (self.isComment(eComment, "USER_DIPLO_KING_LOAN_TIME_RAPPEL")):
			diploScreen.closeScreen()
		
		elif (self.isComment(eComment, "USER_DIPLO_KING_LOAN_PUNISHMENT")):
			diploScreen.closeScreen()
		
		elif (self.isComment(eComment, "USER_DIPLO_KING_LOAN_STOP_PUNISHMENT")):
			diploScreen.closeScreen()
		...
		# if we are asking for something
		elif (self.isComment(eComment, "USER1_DIPLOCOMMENT_CHIEF_GOODY")):
			diploScreen.diploEvent(DiploEventTypes.DIPLOEVENT_DISPLAY_SEEDLING_DISCOVERY, diploScreen.getData(), -1)
			diploScreen.closeScreen()
		...
		# If we declare war to other king
		elif (self.isComment(eComment, "USER_DIPLOCOMMENT_HELP_EUROPEAN_FRIEND")):
			diploScreen.declareWar()
		...
		elif (self.isComment(eComment, "USER1_DIPLO_ACCEPT_LOAN_WAR_SHIP(S)")):
			diploScreen.diploEvent(DiploEventTypes.DIPLOEVENT_ACCEPT_UNIT_SHIP, true, -1)
			self.setAIComment(self.getCommentID("AI_DIPLO_ACCEPT_LOAN_WAR_SHIP(S)"), gc.getPlayer(gc.getGame().getActivePlayer()).getEuropeLoan())

		elif (self.isComment(eComment, "USER2_DIPLO_ACCEPT_LOAN_WAR_SHIP(S)")):
			diploScreen.closeScreen()

		elif (self.isComment(eComment, "USER1_DIPLO_REFUSE_LOAN_WAR_SHIP(S)")):
			diploScreen.diploEvent(DiploEventTypes.DIPLOEVENT_ACCEPT_UNIT_SHIP, false, -1)
			self.setAIComment(self.getCommentID("AI_DIPLO_REFUSE_LOAN_WAR_SHIP(S)"))
			
		elif (self.isComment(eComment, "USER2_DIPLO_REFUSE_LOAN_WAR_SHIP(S)")):
			diploScreen.closeScreen()
			
		elif (self.isComment(eComment, "USER1_DIPLO_ACCEPT_LOAN_WAR_SHIP_NO_ATTACK")):
			diploScreen.diploEvent(DiploEventTypes.DIPLOEVENT_ACCEPT_UNIT_SHIP_NO_ATTACK, true, -1)
			self.setAIComment(self.getCommentID("AI_DIPLO_ACCEPT_LOAN_WAR_SHIP_NO_ATTACK"), gc.getPlayer(gc.getGame().getActivePlayer()).getEuropeLoan())

		elif (self.isComment(eComment, "USER1_DIPLO_REFUSE_LOAN_WAR_SHIP_NO_ATTACK")):
			diploScreen.diploEvent(DiploEventTypes.DIPLOEVENT_ACCEPT_UNIT_SHIP_NO_ATTACK, false, -1)
			self.setAIComment(self.getCommentID("AI_DIPLO_REFUSE_LOAN_WAR_SHIP_NO_ATTACK"))
		...
		elif (self.isComment(eComment, "USER_DIPLOCOMMENT_FOUND_CITY_BUY_FREE")):
			diploScreen.diploEvent(DiploEventTypes.DIPLOEVENT_FOUND_CITY, diploScreen.getData(), false)
			diploScreen.closeScreen()
